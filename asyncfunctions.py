...
def file_write_tasks(text,list_of_informations):
    ...
    for i in list_of_informations:
        ...
        if 'profesor' in i[3] and i[2] == 'M':
            answers = [i[0],i[4],"Szanowny Panie Profesorze","Pana","zechciałby Pan","Pana","Pan zainteresowany", "Pana", "Panu","Przemysła"]
        elif 'profesor' in i[3] and i[2] == 'F':
            answers = [i[0],i[4],"Szanowna Pania Profesor","Pani","zechciałaby Pani","Pani","Pani zainteresowana", "Pani", "Pani","Przemysł"]
        elif 'dr' in i[1] and i[2] == 'M':
            answers = [i[0],i[4],"Szanowny Panie Doktorze","Pana","zechciałby Pan","Pana","Pan zainteresowany", "Pana", "Panu","Przemysła"]
        elif 'dr' in i[1] and i[2] == 'F':
            answers = [i[0],i[4],"Szanowna Pani Doktor","Pani","zechciałaby Pani","Pani","Pani zainteresowana", "Pani", "Pani","Przemysła"]
        elif i[2] == 'F':
            answers = [i[0],i[4],"Szanowna Pani ...", "Pani", "zechciałaby Pani", "Pani", "Pani zainteresowana", "Pani", "Pani",
                       "Przemysła"]
        else:
            answers = [i[0],i[4],"Szanowny Panie ...","Pana","zechciałby Pan","Pana","Pan zainteresowany", "Pana", "Panu","Przemysła"]
